...
$$ \frac{\partial \mathcal{L}}{\partial f_{i}} - \sum_{j=1}^{n}{\frac{\partial}{\partial x_{j}} \left(\frac{\partial \mathcal{L}}{\partial f_{i,j}}\right)}= 0_{i} $$
